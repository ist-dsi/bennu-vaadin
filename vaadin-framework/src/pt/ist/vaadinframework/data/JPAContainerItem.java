...
//		    container.containerItemPropertyModified(JPAContainerItem.this, propertyId);
//		} else {
...
//	this(container, entity, container.getEntityClassMetadata().getPropertyValue(entity,
//		container.getEntityClassMetadata().getIdentifierProperty().getName()), true);
//    }
//
//    /**
...
//	    ((Property.ValueChangeNotifier) getItemProperty(propertyId)).addListener(listener);
//	}
//    }
//
//    public void removeListener(ValueChangeListener listener) {
...
//	 */
//	for (String propertyId : getItemPropertyIds()) {
//	    ((Property.ValueChangeNotifier) getItemProperty(propertyId)).removeListener(listener);
//	}
//    }
// }
