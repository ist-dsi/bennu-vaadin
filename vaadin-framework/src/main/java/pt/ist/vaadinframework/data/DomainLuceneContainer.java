 ...
 */
public class DomainLuceneContainer<Type extends AbstractDomainObject> extends DomainContainer<Type> implements LuceneContainer {

    private int maxHits = 1000000;

    public DomainLuceneContainer(Class<? extends Type> elementType) {
