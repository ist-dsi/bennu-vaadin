...
public class BennuContainer<Type> {
    //
    ...
    // private static final long serialVersionUID = 4888206027909988341L;
    //
    // /**
    // * Linked list of ordered Item IDs.
    // */
    // private final ArrayList<Type> itemIds = new ArrayList<Type>();
    //
    // /** List of item ids that passes the filtering */
    // private LinkedHashSet<Type> filteredItemIds = null;
    //
    // /**
    ...
    // */
    // private final Map<Object, Class<?>> types = new HashMap<Object,
    // Class<?>>();
    //
    // /**
    ...
    // */
    // private final Map<Type, Item> items = new HashMap<Type, Item>();
    //
    // /**
    // * Set of properties that are read-only.
    // */
    // private final Set<Object> readOnlyProperties = new HashSet<Object>();
    //
    // /**
    ...
    //
    // public BennuContainer() {
    // }
    //
    // public BennuContainer(Collection<Type> itemIds) {
    // if (items != null) {
    ...
    // if (itemId != null && items.containsKey(itemId) && (filteredItemIds ==
    // null || filteredItemIds.contains(itemId))) {
    ...
    //
    // /**
    // * Generates an unique identifier for use as an item id. Guarantees that
    // the
    ...
    // final Property.ValueChangeEvent event = new
    // IndexedContainer.PropertyValueChangeEvent(source);
    ...
    // final Hashtable propertySetToListenerListMap = (Hashtable)
    // singlePropertyValueChangeListeners.get(source.propertyId);
    // if (propertySetToListenerListMap != null) {
    // final LinkedList listenerList = (LinkedList)
    // propertySetToListenerListMap.get(source.itemId);
    ...
    // final Container.PropertySetChangeEvent event = new
    // IndexedContainer.PropertySetChangeEvent(this);
    // for (int i = 0; i < l.length; i++) {
    ...
    // final Container.ItemSetChangeEvent event = new
    // IndexedContainer.ItemSetChangeEvent(this, addedItemIndex);
    // for (int i = 0; i < l.length; i++) {
    ...
    // */
    // private void addSinglePropertyChangeListener(Object propertyId, Object
    // itemId, Property.ValueChangeListener listener) {
    // if (listener != null) {
    // if (singlePropertyValueChangeListeners == null) {
    // singlePropertyValueChangeListeners = new Hashtable();
    // }
    // Hashtable propertySetToListenerListMap = (Hashtable)
    // singlePropertyValueChangeListeners.get(propertyId);
    // if (propertySetToListenerListMap == null) {
    ...
    // propertySetToListenerListMap.get(itemId);
    // if (listenerList == null) {
    ...
    // */
    // private void removeSinglePropertyChangeListener(Object propertyId, Object
    // itemId, Property.ValueChangeListener listener) {
    ...
    // * <code>Collections.sort(aCollection, getItemSorter())</code> on all
    // arrays
    ...
    //
    // /**
    // * Sets the ItemSorter used for comparing items in a sort. The ItemSorter
    // is
    ...
    // nc.itemSetChangeListeners = itemSetChangeListeners != null ? (LinkedList)
    // itemSetChangeListeners.clone() : null;
    // nc.propertyIds = propertyIds != null ? (ArrayList) propertyIds.clone() :
    // null;
    // nc.propertySetChangeListeners = propertySetChangeListeners != null ?
    // (LinkedList) propertySetChangeListeners.clone()
    // : null;
    // nc.propertyValueChangeListeners = propertyValueChangeListeners != null ?
    // (LinkedList) propertyValueChangeListeners
    // .clone() : null;
    // nc.readOnlyProperties = readOnlyProperties != null ? (HashSet)
    // readOnlyProperties.clone() : null;
    // nc.singlePropertyValueChangeListeners =
    // singlePropertyValueChangeListeners != null ? (Hashtable)
    ...
    //
    // nc.filteredItemIds = filteredItemIds == null ? null : (LinkedHashSet)
    // filteredItemIds.clone();
    //
    ...
    // * filtering has taken place. Updates internal data structures and fires
    // an
    ...
    // * This method should reset any internal data structures and then
    // repopulate
    // * them so {@link #getItemIds()} and other methods only return the
    // filtered
    // * items.
    // *
    // * @param hasFilters
