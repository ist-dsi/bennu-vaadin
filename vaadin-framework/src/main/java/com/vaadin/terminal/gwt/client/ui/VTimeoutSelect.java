 ...
 */
public class VTimeoutSelect extends Composite implements Paintable, Field,
        ...
        public void setPosition(int offsetWidth, int offsetHeight) {
            ...
            if (offsetHeight + getPopupTop() > Window.getClientHeight()
                ...
                top = getPopupTop() - offsetHeight
                        - VTimeoutSelect.this.getOffsetHeight();
                if (top < 0) {
                    top = 0;
                }
            } else {
            ...
            if (offsetWidth + getPopupLeft() > Window.getClientWidth()
                ...
                left = VTimeoutSelect.this.getAbsoluteLeft()
                        + VTimeoutSelect.this.getOffsetWidth()
