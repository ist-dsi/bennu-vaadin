...
/**
 * Common behaviour for container notifiers.
 * 
 * @author Pedro Santos (pedro.miguel.santos@ist.utl.pt)
 */
@SuppressWarnings("serial")
public abstract class NotifierContainer implements Container, Container.PropertySetChangeNotifier,
	...
	private PropertySetChangeEvent(NotifierContainer source) {
	    super(source);
	}

	@Override
	public NotifierContainer getContainer() {
	    return (NotifierContainer) getSource();
	}
    }
	...
	private ItemSetChangeEvent(NotifierContainer source) {
	    super(source);
	}
