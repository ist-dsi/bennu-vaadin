...
/**
 * Common behaviour for property notifiers.
 * 
 * @author Pedro Santos (pedro.miguel.santos@ist.utl.pt)
 */
@SuppressWarnings("serial")
public abstract class NotifierProperty implements Property, Property.ValueChangeNotifier, Property.ReadOnlyStatusChangeNotifier {
	...
	protected ValueChangeEvent(NotifierProperty source) {
	    super(source);
	}

	public NotifierProperty getProperty() {
	    return (NotifierProperty) getSource();
	}
    }
