...
/**
 * Common behaviour for item notifiers.
 * 
 * @author Pedro Santos (pedro.miguel.santos@ist.utl.pt)
 */
@SuppressWarnings("serial")
public abstract class NotifierItem implements Item, Item.PropertySetChangeNotifier {
	...
	private PropertySetChangeEvent(NotifierItem source) {
	    super(source);
	}
