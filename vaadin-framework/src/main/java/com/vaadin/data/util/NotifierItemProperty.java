...
/**
 * Common behaviour for both item and property notifiers.
 * 
 * @author Pedro Santos (pedro.miguel.santos@ist.utl.pt)
 */
@SuppressWarnings("serial")
public abstract class NotifierItemProperty extends NotifierProperty implements Item, Item.PropertySetChangeNotifier {
	...
	private PropertySetChangeEvent(NotifierItemProperty source) {
	    super(source);
	}
