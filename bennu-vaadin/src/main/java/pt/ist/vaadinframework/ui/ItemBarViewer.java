 ...
 *
 */
public class ItemBarViewer extends CustomComponent implements Item.Viewer, Item.PropertySetChangeListener, Item.PropertySetChangeNotifier {
	...
	if(itemDataSource != null
		&& Item.PropertySetChangeNotifier.class
		.isAssignableFrom(itemDataSource.getClass())) {
	...
	nameLabel.setPropertyDataSource(itemDataSource.getItemProperty("name"));
    }
    
    /**
     * Override this method to control the avatar icon that is associated to the item bar.
	...
	addListener(Item.PropertySetChangeListener.class, listener, PROPERTY_SET_CHANGE_METHOD);
    }

    @Override
    public void removeListener(PropertySetChangeListener listener) {
	removeListener(Item.PropertySetChangeListener.class, listener, PROPERTY_SET_CHANGE_METHOD);
    }
    ...
    private static final Method PROPERTY_SET_CHANGE_METHOD;
    
    static {
        try {
            PROPERTY_SET_CHANGE_METHOD = Item.PropertySetChangeListener.class
                    .getDeclaredMethod("itemPropertySetChange",
                            new Class[] { Container.PropertySetChangeEvent.class });
